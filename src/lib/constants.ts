...
export const PUBLIC_BSKY_SERVICE = `https://${PUBLIC_APPVIEW_DOMAIN}`
...
export const PROD_DEFAULT_FEED = (rkey: string) =>
  `at://${FEED_OWNER_DID}/app.bsky.feed.generator/${rkey}`
...
export const PUBLIC_APPVIEW = `https://${PUBLIC_APPVIEW_DOMAIN}`
export const PUBLIC_APPVIEW_DID = `did:web:${PUBLIC_APPVIEW_DOMAIN}`
